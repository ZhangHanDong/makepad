...
- `old/studio/ai/src/backends/claude_acp.rs`
...
- Add a new backend implementation under `old/studio/ai/src/backends/`.
- Export it from `old/studio/ai/src/backends/mod.rs`.
...
```text
old/studio/ai/src/backends/claude_code_cli.rs
```
...
- Add `ClaudeCodeCliAgent` under `old/studio/ai/src/backends/claude_code_cli.rs`.
...
```text
old/studio/ai/src/backends/claude_code_tmux.rs
```
