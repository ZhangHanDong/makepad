...
- The implementation lives under `old/studio/ai/src/backends/`.
...
Scenario: Claude Code backend module is exported through makepad-ai
  ...
  Given `ClaudeCodeCliAgent` is implemented under `old/studio/ai/src/backends/`
