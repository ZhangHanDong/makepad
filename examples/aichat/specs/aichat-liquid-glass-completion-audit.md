...
| ShaderBackdrop fallback route | `aichat-liquid-glass-v4.2-route-decision.md` selects `ShaderBackdropInterior` for complete aichat interior visuals; Step 98 keeps complete interior work on ShaderBackdrop/hybrid | Separate route, not full Apple-native support. |
...
verdict rejects that prototype as production full native glass. They do not
prove UIKit support, native interactive controls, advanced native behavior, or
full native interior Liquid Glass.
