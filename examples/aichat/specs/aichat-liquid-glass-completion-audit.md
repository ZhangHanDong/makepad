...
- Native interactive controls are only partially implemented. Steps 100-112
  ...
  control batches. Accessibility ownership is unresolved, and non-macOS
  backends remain no-op.
