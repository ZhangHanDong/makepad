...
- Phase I popup/modal policy is defined in
  ...
  Physical outside-click/Escape dismissal, UIKit transient implementation and
  runtime validation, and modal windows remain incomplete.
