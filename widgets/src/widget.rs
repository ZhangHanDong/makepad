...
impl WidgetRef {
    ...
    */
    ...
    pub fn interaction_child_visibility(&self, visit: &mut dyn FnMut(WidgetUid, bool)) -> bool {
        self.try_interaction_child_visibility(visit)
    }

    pub fn try_interaction_child_visibility(&self, visit: &mut dyn FnMut(WidgetUid, bool)) -> bool {
